...
function ChatArea() {
  ...
  const sendMessage = () => {
    ...
    axios
      .post(
        "mern-project-final-rho.vercel.app/message/",
        {
  ...
  useEffect(() => {
    ...
    axios
      .get("mern-project-final-rho.vercel.app/message/" + chat_id, config)
      .then(({ data }) => {
        setAllMessages(data);
        setloaded(true);
  ...
  const deleteChatsWithUser = async () => {
    try {
      ...
      await axios.delete(`mern-project-final-rho.vercel.app/chat/deleteChats/${userId}`, config);
    ...
    return (
      <div className={"chatArea-container" + (lightTheme ? "" : " dark")}>
        <div className={"chatArea-header" + (lightTheme ? "" : " dark")}>
          ...
          <IconButton className={"icon" + (lightTheme ? "" : " dark")}onClick={deleteChatsWithUser}>
            <DeleteIcon />
          </IconButton>
        </div>
